...
pub const AGENTS: &[AgentInfo] = &[
    ...
    AgentInfo {
        name: "trae",
        display_color: Color::LightCyan,
        resume: ResumePattern::CliFlagEq {
            binary: "trae-cli",
            flag: "--resume",
        },
    },
    ...
    AgentInfo {
        name: "cursor",
        display_color: Color::LightGreen,
        resume: ResumePattern::Unsupported,
    },
    AgentInfo {
        name: "copilot",
    ...
    AgentInfo {
        name: "iflow",
        display_color: Color::LightBlue,
        resume: ResumePattern::Unsupported,
    },
    AgentInfo {
        name: "kilocode",
        display_color: Color::LightYellow,
        resume: ResumePattern::Unsupported,
    },
    AgentInfo {
        name: "kimi",
        display_color: Color::LightMagenta,
        resume: ResumePattern::Unsupported,
    },
    AgentInfo {
        name: "kiro",
    ...
    AgentInfo {
        name: "qwen",
        display_color: Color::Rgb(255, 165, 0),
        resume: ResumePattern::Unsupported,
    },
    AgentInfo {
        name: "pi",
...
mod tests {
    ...
    fn test_resume_agents_count() {
        let resumable: Vec<_> = AGENTS
            .iter()
            .filter(|a| !matches!(a.resume, ResumePattern::Unsupported))
            .collect();
